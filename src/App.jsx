...
const DailyMusterPage = lazy(() => import('./pages/ProjectWorkflow/DailyMusterPage'));
const ItemCataloguePage = lazy(() => import('./pages/Inventory/ItemCataloguePage'));
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<Main />}>
              ...
              {/* contracts/new removed — contracts are created inside Project Detail */}
              ...
              {/* Daily Muster — new route replacing role-contracts/record-daily */}
              <Route path="projects/:projectId/contracts/:contractId/muster" element={<DailyMusterPage />} />
              <Route path="projects/:projectId/contracts/:contractId/muster/:date" element={<DailyMusterPage />} />

              {/* New contract detail route under projects */}
              <Route path="projects/:projectId/contracts/:contractId" element={<ContractDetailsPage />} />

              {/* Item Catalogue */}
              <Route path="inventory/catalogue" element={<ItemCataloguePage />} />
