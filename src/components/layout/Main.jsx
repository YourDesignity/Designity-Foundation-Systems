...
//
// FIXES APPLIED:
//  - Removed duplicate import of responsive.css (was byte-for-byte identical to main.css)
//  - CSS is already imported in App.jsx — removed the redundant second import here too
//    to prevent the same styles loading 4 times.
